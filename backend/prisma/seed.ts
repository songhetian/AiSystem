...
const buttonDefs: ButtonDef[] = [
  ...
  // 财务管理按钮权限
  ["finance:dashboard:view", "View Finance Dashboard", "finance:dashboard"],
  ["finance:dashboard:export", "Export Finance Data", "finance:dashboard"],
  ["finance:reimbursement:list", "View Reimbursements", "finance:reimbursement"],
  ["finance:reimbursement:create", "Create Reimbursement", "finance:reimbursement"],
  ["finance:reimbursement:update", "Update Reimbursement", "finance:reimbursement"],
  ["finance:reimbursement:delete", "Delete Reimbursement", "finance:reimbursement"],
  ["finance:reimbursement:approve", "Approve Reimbursement", "finance:reimbursement"],
  ["finance:reimbursement:reject", "Reject Reimbursement", "finance:reimbursement"],
  ["finance:reimbursement:pay", "Mark as Paid", "finance:reimbursement"],
  ["finance:reimbursement:export", "Export Reimbursements", "finance:reimbursement"],
  ["finance:purchase:list", "View Purchases", "finance:purchase"],
  ["finance:purchase:create", "Create Purchase", "finance:purchase"],
  ["finance:purchase:update", "Update Purchase", "finance:purchase"],
  ["finance:purchase:delete", "Delete Purchase", "finance:purchase"],
  ["finance:purchase:approve", "Approve Purchase", "finance:purchase"],
  ["finance:purchase:reject", "Reject Purchase", "finance:purchase"],
  ["finance:purchase:complete", "Mark as Completed", "finance:purchase"],
  ["finance:purchase:export", "Export Purchases", "finance:purchase"],
  ["finance:cash-record:list", "View Cash Records", "finance:cash-record"],
  ["finance:cash-record:create", "Create Cash Record", "finance:cash-record"],
  ["finance:cash-record:update", "Update Cash Record", "finance:cash-record"],
  ["finance:cash-record:delete", "Delete Cash Record", "finance:cash-record"],
  ["finance:cash-record:export", "Export Cash Records", "finance:cash-record"],
