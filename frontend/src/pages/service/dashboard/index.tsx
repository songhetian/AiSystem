    ...
    <div className="p-6 h-full flex flex-col gap-6">
      <div className="flex justify-between items-center bg-white p-4 rounded-lg shadow-sm border border-slate-200">
        ...
        <Space>
          <Text className="text-slate-500 font-bold">
            数据刷新时间: {new Date().toLocaleString()}
          </Text>
        </Space>
      </div>
      ...
      <Row gutter={[24, 24]}>
        ...
        <Col span={6}>
          ...
          >
            <Statistic
              title={
                <Text className="text-slate-600 font-bold">高危流失会话</Text>
              }
        ...
        <Col span={6}>
          ...
          >
            <Statistic
              title={
                <Text className="text-slate-600 font-bold">质检合格率</Text>
              }
        ...
        <Col span={6}>
          ...
          >
            <Statistic
              title={
                <Text className="text-slate-600 font-bold">敏感词拦截</Text>
              }
      ...
      <Row gutter={[24, 24]} className="flex-1">
        <Col span={12}>
          <Card
            title={
              <span className="text-slate-900 font-black">流失风险分布</span>
            }
            bordered={false}
          ...
          >
            <div className="flex flex-col gap-3">
              {metrics?.topFaqs?.map((faq: any, index: number) => (
                ...
                >
                  <Text className="text-slate-900 font-bold truncate max-w-[80%]">
