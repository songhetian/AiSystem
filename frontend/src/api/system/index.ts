...
export const systemApi = {
  ...
  batchUpdatePlatformStatus: (payload: { ids: string[]; status: number }) => request.patch('/system/platforms/batch/status', payload),
  ...
  batchUpdateDepartmentStatus: (payload: { ids: string[]; status: number }) => request.patch('/system/departments/batch/status', payload),
  ...
  batchUpdateShopStatus: (payload: { ids: string[]; status: number }) => request.patch('/system/shops/batch/status', payload),
